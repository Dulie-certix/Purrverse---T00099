...
export default function Section1() {
  return (
    <section id="Section1" className="w-full h-full min-w-screen  flex items-center justify-center relative -mt-[260px]">
        ...
        {/* Content */}
        <div className="relative z-10 max-w-[1920px] max-h-[1080px] w-full h-full flex flex-col justify-center items-center">
