...
export default function Hero() {
  return (
    <section
      id="Hero"
      className="relative z-10 flex h-auto w-screen items-center justify-center overflow-hidden"
    >
      ...
      <div className="justify-top 3xl:min-h-[1181px] relative z-20 flex max-h-[1080px] min-h-[600px] max-w-[1920px] flex-col items-center sm:min-h-[800px] md:min-h-[900px] lg:min-h-[1000px] xl:min-h-[1100px]">
        {/* Cat  */}
        <AnimatedElement animation="zoom-in" duration={1000}>
        ...
        {/* Ring */}
        <AnimatedElement animation="zoom-out" delay={500} duration={900}>
            <div>
              <img
                src={Ring}
                alt="Ring"
        ...
        <div className="justify-left 3xl:h-[375px] 3xl:max-w-[1252px] z-[-10] mt-[-520px] h-[100px] w-full max-w-[650px] sm:h-[250px] sm:max-w-[800px] md:h-[250px] md:max-w-[750px] lg:mx-auto lg:mt-[-575px] lg:h-[320px] lg:max-w-[1050px] xl:mt-[-610px] xl:h-[350px] xl:max-w-[1150px]">
          <Cloud delay={1} className="3xl:mt-[680px] 3xl:ml-[370px] 3xl:h-[340px] 3xl:w-[555px] mt-[570px] ml-[20px] h-[100px] w-[150px] sm:mt-[550px] sm:ml-[150px] sm:h-[220px] sm:w-[280px] md:mt-[585px] md:ml-[180px] md:h-[230px] md:w-[300px] lg:mt-[600px] lg:ml-[220px] lg:h-[300px] lg:w-[420px] xl:mt-[650px] xl:ml-[280px] xl:h-[320px] xl:w-[480px]" />
          <Cloud delay={0} className="3xl:mt-[-375px] 3xl:h-[340px] 3xl:w-[555px] mt-[-100px] ml-[120px] h-[100px] w-[150px] sm:mt-[-200px] sm:ml-[0px] sm:h-[220px] sm:w-[280px] md:mt-[-250px] md:h-[230px] md:w-[300px] lg:mt-[-320px] lg:h-[300px] lg:w-[420px] xl:mt-[-350px] xl:h-[320px] xl:w-[480px]" />
          <Cloud delay={0} className="3xl:mt-[-300px] 3xl:ml-[700px] 3xl:h-[340px] 3xl:w-[555px] mt-[-100px] ml-[180px] h-[100px] w-[120px] sm:mt-[-200px] sm:ml-[300px] sm:h-[220px] sm:w-[280px] md:mt-[-210px] md:ml-[400px] md:h-[230px] md:w-[300px] lg:mt-[-270px] lg:ml-[480px] lg:h-[300px] lg:w-[420px] xl:mt-[-270px] xl:ml-[580px] xl:h-[320px] xl:w-[480px]" />
        </div>
      </div>
    </section>
  );
